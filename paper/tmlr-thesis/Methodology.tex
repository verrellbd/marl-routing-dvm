...
nodes and links \cite{Rusek_2020}, and learning follows Centralized Training with
Decentralized Execution \cite{marl-book}. Three principles govern the design:
\begin{enumerate}
...
(Sections~\ref{sec:setup-train} and~\ref{sec:setup-instances}). A routing assigns
