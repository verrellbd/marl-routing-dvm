...
\begin{table}[htbp]
  \centering
  \small
  \caption{Quality of Service Results.}
  \label{tab:qos}
  ...
  \begin{tabular}{llcccc}
    ...
    \midrule
    \multirow{2}{*}{Abilene}   & Loss  & \textbf{0.17\%}   & 0.22 $\pm$ 0.04\%             & 1.01 $\pm$ 1.65\%   & 0.56 $\pm$ 0.67\%   \\
                               & Delay & \textbf{11.5\,ms} & 12.8 $\pm$ 1.3\,ms           & 21.6 $\pm$ 16.2\,ms  & 13.7 $\pm$ 3.7\,ms  \\

    \cmidrule(l){1-6}
    \multirow{2}{*}{GÉANT}     & Loss  & 0.16\%   & \textbf{0.12 $\pm$ 0.00\%}            & 0.98 $\pm$ 2.04\%   & \textbf{0.12 $\pm$ 0.00\%}  \\
                               & Delay & 9.5\,ms  & \textbf{8.1 $\pm$ 0.1\,ms}           & 12.8 $\pm$ 4.0\,ms  & 8.5 $\pm$ 0.3\,ms \\

    \cmidrule(l){1-6}
    \multirow{2}{*}{Germany50} & Loss  & \textbf{0.03\%}  & 0.26 $\pm$ 0.35\%             & \textbf{0.03 $\pm$ 0.00\%} & 1.09 $\pm$ 0.83\% \\
